...
``` javascript
<script src="https://cdn.authing.cn/sdk/javascript/authing-login-form-1.1.0.js"></script>
```
...
``` html
<script src="https://cdn.authing.cn/sdk/javascript/login-form.1.1.0.js"></script>
<script>
  new AuthingForm({
    clientId: '填入_Authing_的_client_ID',
    secret: '填入_Authing_client_ID_的_secret'
